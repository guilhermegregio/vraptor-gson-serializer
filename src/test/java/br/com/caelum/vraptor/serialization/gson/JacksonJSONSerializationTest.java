...
public class JacksonJSONSerializationTest {
    ...
    public void setup() throws Exception {
		...
		this.serialization = new JacksonSerialization(response);
    }
...
//		String expectedResult = "<order><client></client>  <price>15.0</price><comments>pack it nicely, please</comments></order>";
	...
	public void shouldRunHibernateLazyInitialization() throws Exception {
		...
		/*
		Expected: "{\"client\":{\"name\":\"my name\",\"aField\":\"abc\"}}"
		     got: "{\"someProxy\":{\"name\":\"my name\",\"aField\":\"abc\",\"serialVersionUID\":1}}"
		 */
	}
